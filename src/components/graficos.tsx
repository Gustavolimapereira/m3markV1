    ...
    <div className=" w-full h-full flex flex-col justify-center items-center">
      <div className="w-3/4 h-40 bg-customColorCard px-3 relative space-y-2 rounded-xl mb-6">
        ...
        <div className="flex space-x-2.5 justify-start items-center py-4">
          <div
              className=" bg-customColorRed rounded-full h-2.5 w-2.5"
          ></div>
          <div
              className=" bg-customColorYellow rounded-full h-2.5 w-2.5"
          ></div>
          <div
              className=" bg-customColorDarkGreen rounded-full h-2.5 w-2.5"
          ></div>
        </div>
